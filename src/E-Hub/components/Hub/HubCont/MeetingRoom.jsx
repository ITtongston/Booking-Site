  ...
  return (
    <ContainerBox className="Hub1">
      <Box sx={{border: 'solid 2px #b3b3b3', borderRadius: '5px', p: 3, width:{sm: 400, xs: 300}, mb: '10%'}}>
        <Typography variant='h6' sx={{color: "#0C0145", fontSize: {xs: '11px', sm: '13px'}, fontWeight: 600}}> Meeting Room For Your Team</Typography>
        <Typography variant="h5" sx={{fontWeight: 'bold', fontSize: {sm: '16px'}}}>Meeting Room</Typography>
      ...
      <BoxFeatures>
        <div data-aos="fade-up" data-aos-duration="900"><Cardbox4/></div>
