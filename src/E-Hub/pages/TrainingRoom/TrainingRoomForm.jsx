...
const Details = ({ onNext, goBack }) => {
  ...
  if (checkedStates.Water) waterPrice = 500;
  else waterPrice = 0;
  if (checkedStates.BoardDuster) dusterPrice = 500;
  else dusterPrice = 0;
  if (checkedStates.BoardMarker) markerPrice = 500;
  else markerPrice = 0;
  if (checkedStates.HDMICable) hdmiPrice = 500;
  else hdmiPrice = 0;
  if (checkedStates.Wifi) wifi = 500;
  else wifi = 0;
  if (checkedStates.WeekendUse) weekendCharge = 500;
